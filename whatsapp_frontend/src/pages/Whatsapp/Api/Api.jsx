                                            ...
                                            <Card className="mb-2" key={`${groupName}-${index}`}>
                                                ...
                                                {isActive && (
                                                    <Card.Body>
                                                                    ...
                                                                    <tbody>
                                                                        {ep.requestModel.map((field, i) => (
                                                                            <React.Fragment key={`req-${i}`}>
                                                                                ...
                                                                                {Array.isArray(field.children) && field.children.map((child, j) => (
                                                                                    <tr key={`req-${i}-${j}`}>
                                                        ...
                                                        {Array.isArray(ep.responseModel) && ep.responseModel.length > 1 && (
                                                            <>
                                                        ...
                                                        {Array.isArray(ep.responseModel) && ep.responseModel.length === 1 && ep.responseModel[0].field === "Code" && (
